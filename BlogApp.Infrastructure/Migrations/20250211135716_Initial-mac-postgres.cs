...
{
    /// <inheritdoc />
    public partial class Initialmacpostgres : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlogHistoryId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BlogId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentHistoryId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CommentId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    CommentDescription = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2d4e75ee-597a-4aff-ace5-ae9c94389faa", "2d4e75ee-597a-4aff-ace5-ae9c94389faa", "Admin", "ADMIN" },
                    { "d6bcd84d-2590-498a-a5f7-71ca3dd6ccdc", "d6bcd84d-2590-498a-a5f7-71ca3dd6ccdc", "Superadmin", "SUPERADMIN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "b0ef87b9-88e7-4117-bde8-abe605ae18b1", 0, "44000443-b1b4-4a82-b6f0-7f68cde81320", "Users", "superadmin@blog.com", true, false, null, "SUPERADMIN@BLOG.COM", "SUPERADMIN", "AQAAAAIAAYagAAAAEGxRsmvywBh7RYg+MDhVcQ3enGH/u14/JyF4ZXBDdysRVmzpi6htocOwv3aTF49f8w==", null, false, "5004126d-5e7c-4176-b0a7-ea40b012add2", false, "Superadmin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "d6bcd84d-2590-498a-a5f7-71ca3dd6ccdc", "b0ef87b9-88e7-4117-bde8-abe605ae18b1" });
